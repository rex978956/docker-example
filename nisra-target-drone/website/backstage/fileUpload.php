...
<body>
    ...
    <main class="container-fluid">
        <div class="row align-items-stretch justify-content-center">
            <!-- sidebar -->
            <section class="col-lg-3 d-flex flex-column p-3 text-white bg-dark" style="width: 280px; height: 100vh;">
                <a class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none" href="./index.php?id=<?php echo $id; ?>">
                    <img class="bi me-2" src="/images/logos/logo-sm.png" alt="nisra logo" width="35" height="35">
                    <span class="fs-4">NISRA</span>
                </a>
                <hr>
                <ul id="itemlist" class="nav nav-pills flex-column mb-auto">
                    <li id="home" class="nav-item">
                        <a class="nav-link active" aria-current="page" href="./index.php?id=<?php echo $id; ?>">
                            <svg class="bi me-2" width="16" height="16"><use xlink:href="#home"/></svg>
                            <span>Home</span>
                        </a>
                    </li>
                    <li id="members" class="nav-item">
                        <a class="nav-link text-white" href="./members.php?id=<?php echo $id; ?>">
                            <svg class="bi me-2" width="16" height="16"><use xlink:href="#people-circle"/></svg>
                            <span>Members</span>
                        </a>
                    </li>
                    <li id="events" class="nav-item">
                        <a class="nav-link text-white" href="./events.php?id=<?php echo $id; ?>">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                        <li><a class="dropdown-item" href="./setting.php?id=<?php echo $id; ?>">Settings</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="index.php?logout='1'">Sign out</a></li>
                    </ul>
                </div>
            </section>
...
<script>
    ...
    let permission = <?php echo $permission; ?>;
    if (permission < 2) {
        items.removeChild(members);
    } 
    if (permission < 1) {
        items.removeChild(events);
        items.removeChild(lessons);
    }
</script>
</html>
